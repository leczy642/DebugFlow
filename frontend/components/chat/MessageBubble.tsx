...
import { ClipboardDocumentIcon, TrashIcon, ArrowPathIcon, ChevronLeftIcon, ChevronRightIcon, PencilSquareIcon, CheckIcon, XMarkIcon } from "@heroicons/react/24/outline";
          ...
          <div className="flex items-center gap-2 mt-1 self-end">
            ...
            <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              {isUser && onEdit ? (
                ...
                onDelete && (
                  <button onClick={onDelete} title="Delete" className="p-1 hover:bg-red-100 rounded text-gray-500 hover:text-red-600">
